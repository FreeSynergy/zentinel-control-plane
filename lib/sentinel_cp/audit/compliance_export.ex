defmodule SentinelCp.Audit.ComplianceExport do
  @moduledoc """
  ...
  defp to_cef(log) do
    ...
    "CEF:0|SentinelCP|ControlPlane|1.0|#{log.action}|#{log.action}|#{severity}|" <>
      "rt=#{timestamp} " <>
      "duid=#{log.id} " <>
  ...
  defp to_leef(log) do
    ...
    "LEEF:2.0|SentinelCP|ControlPlane|1.0|#{log.action}|" <>
      "devTime=#{timestamp}\t" <>
