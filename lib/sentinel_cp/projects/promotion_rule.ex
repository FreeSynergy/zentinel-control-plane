defmodule SentinelCp.Projects.PromotionRule do
  @moduledoc """
  ...
  schema "promotion_rules" do
    ...
    belongs_to :source_env, SentinelCp.Projects.Environment
    belongs_to :target_env, SentinelCp.Projects.Environment
