defmodule SentinelCp.GraphQL.Schema do
  @moduledoc """
  GraphQL schema definition for the Sentinel Control Plane API.
    ...
    %{
      query: %{
        project: %{
          ...
          type: :project,
          resolver: {SentinelCp.Projects, :get_project_by_slug}
        },
        projects: %{
          args: %{org_id: :id},
          type: [:project],
          resolver: {SentinelCp.Projects, :list_projects}
        },
        services: %{
          args: %{project_id: :id},
          type: [:service],
          resolver: {SentinelCp.Services, :list_services}
        },
        nodes: %{
          args: %{project_id: :id},
          type: [:node],
          resolver: {SentinelCp.Nodes, :list_nodes}
        },
        bundles: %{
          args: %{project_id: :id, limit: :integer},
          type: [:bundle],
          resolver: {SentinelCp.Bundles, :list_bundles}
        },
        rollouts: %{
          args: %{project_id: :id},
          type: [:rollout],
          resolver: {SentinelCp.Rollouts, :list_rollouts}
        },
        alert_rules: %{
          args: %{project_id: :id},
          type: [:alert_rule],
          resolver: {SentinelCp.Observability, :list_alert_rules}
        },
        slos: %{
          args: %{project_id: :id},
          type: [:slo],
          resolver: {SentinelCp.Observability, :list_slos}
        },
        policies: %{
          args: %{project_id: :id},
          type: [:policy],
          resolver: {SentinelCp.Policies, :list_policies}
        }
      },
      mutation: %{
        create_rollout: %{
          ...
          type: :rollout,
          resolver: {SentinelCp.Rollouts, :create_rollout}
        },
        pause_rollout: %{
          args: %{id: :id},
          type: :rollout,
          resolver: {SentinelCp.Rollouts, :pause_rollout}
        },
        resume_rollout: %{
          args: %{id: :id},
          type: :rollout,
          resolver: {SentinelCp.Rollouts, :resume_rollout}
        },
        create_bundle: %{
          args: %{project_id: :id, config_source: :string, version: :string},
          type: :bundle,
          resolver: {SentinelCp.Bundles, :create_bundle}
        }
      },
      subscription: %{
        rollout_progress: %{
