defmodule SentinelCp.Analytics.RollupWorker do
  @moduledoc """
  ...
  alias SentinelCp.Analytics.{ServiceMetric, MetricRollup}
  ...
  def perform(%Oban.Job{}) do
    ...
    retention_days = Application.get_env(:sentinel_cp, :metrics_retention_days, 7)
