defmodule SentinelCp.Accounts.TotpTest do
  use SentinelCp.DataCase, async: false

  alias SentinelCp.Accounts.Totp
  ...
  describe "UserTotp.otpauth_uri/2" do
    test "generates a valid otpauth URI" do
      ...
      assert String.starts_with?(uri, "otpauth://totp/SentinelCP:test@example.com")
      assert String.contains?(uri, "issuer=SentinelCP")
    end
  end
end
