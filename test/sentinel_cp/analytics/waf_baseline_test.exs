defmodule SentinelCp.Analytics.WafBaselineTest do
  use SentinelCp.DataCase

  alias SentinelCp.Analytics
  alias SentinelCp.Analytics.WafBaseline

  defp create_project(_) do
    {:ok, org} = SentinelCp.Orgs.create_org(%{name: "BL Org", slug: "bl-org"})

    {:ok, project} =
      SentinelCp.Projects.create_project(%{name: "BL Project", slug: "bl-proj", org_id: org.id})
