defmodule SentinelCp.PoliciesTest do
  use SentinelCp.DataCase, async: false

  alias SentinelCp.Policies
  alias SentinelCp.Policies.{Policy, Violation, Evaluator}
  alias SentinelCp.Audit.ComplianceExport
  ...
  describe "compliance export" do
    test "exports in CEF format", %{project: project} do
      ...
      assert output =~ "CEF:0|SentinelCP|ControlPlane"
    ...
    test "exports in LEEF format", %{project: project} do
      ...
      assert is_binary(output)
      assert output =~ "LEEF:2.0|SentinelCP|ControlPlane"
    ...
    test "exports in JSON Lines format", %{project: project} do
      ...
      assert decoded["source"] == "sentinel_cp"
    end
