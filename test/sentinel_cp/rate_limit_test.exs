defmodule SentinelCp.RateLimitTest do
  use ExUnit.Case, async: false

  alias SentinelCp.RateLimit
  ...
  describe "check_rate/3" do
    ...
    test "denies requests over the limit" do
      ...
      Application.put_env(:sentinel_cp, :rate_limits, %{"test_scope" => 3})
      ...
      # Clean up
      Application.delete_env(:sentinel_cp, :rate_limits)
    end

    test "returns correct remaining count" do
      Application.put_env(:sentinel_cp, :rate_limits, %{"count_scope" => 5})
    ...
    test "applies cost multipliers" do
      Application.put_env(:sentinel_cp, :rate_limits, %{"bundles:write" => 10})
  ...
  describe "get_limit/1" do
    ...
    test "prefers application config over defaults" do
      Application.put_env(:sentinel_cp, :rate_limits, %{"nodes:read" => 5000})
