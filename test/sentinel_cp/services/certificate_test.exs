defmodule SentinelCp.Services.CertificateTest do
  use SentinelCp.DataCase, async: true

  alias SentinelCp.Services
  alias SentinelCp.Services.Certificate
  ...
  describe "create_certificate/1" do
    ...
    test "encrypts the private key" do
      ...
      {:ok, decrypted} = SentinelCp.Services.CertificateCrypto.decrypt(cert.key_pem_encrypted)
