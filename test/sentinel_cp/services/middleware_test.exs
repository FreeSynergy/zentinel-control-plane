defmodule SentinelCp.Services.MiddlewareTest do
  use SentinelCp.DataCase

  alias SentinelCp.Services
  alias SentinelCp.Services.{Middleware, ServiceMiddleware, KdlGenerator, ProjectConfig}

  import SentinelCp.ProjectsFixtures
  import SentinelCp.ServicesFixtures
  import SentinelCp.MiddlewareFixtures
