defmodule SentinelCp.Services.ConsulResolverTest do
  use SentinelCp.DataCase

  alias SentinelCp.Services.ConsulResolver.HTTP
  ...
  describe "resolve_service/1 with mock" do
    ...
    test "returns error for non-200 status" do
      ...
      SentinelCp.Services.ConsulResolver.Mock
      ...
      assert {:error, "Consul API returned 403: Permission denied"} =
               SentinelCp.Services.ConsulResolver.Mock.resolve_service(%{
