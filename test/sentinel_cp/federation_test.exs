defmodule SentinelCp.FederationTest do
  use SentinelCp.DataCase, async: false

  alias SentinelCp.Federation
  alias SentinelCp.Federation.{Peer, RegionalStorage, BundleReplication}
  ...
  describe "peer schema" do
    test "creates a valid spoke peer" do
      changeset =
        Peer.changeset(%Peer{}, %{
          name: "US East Spoke",
          url: "https://spoke-us-east.sentinel.example.com",
          role: "spoke",
          region: "us-east-1"
        })
    ...
    test "creates a valid hub peer" do
      changeset =
        Peer.changeset(%Peer{}, %{
          name: "Hub",
          url: "https://hub.sentinel.example.com",
          role: "hub",
          region: "us-west-2"
        })
    ...
    test "creates a valid storage config" do
      changeset =
        RegionalStorage.changeset(%RegionalStorage{}, %{
          region: "us-east-1",
          bucket: "sentinel-bundles-us-east",
